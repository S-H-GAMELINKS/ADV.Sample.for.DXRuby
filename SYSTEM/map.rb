		...
		case mouse
			...
			when ap1
				...
				if Input.mouse_push?(M_LBUTTON) then
					...
					#「はい」を押すと終了
					if messagebox.Popup("日御碕灯台に行きますか？", 10, "DXRuby ADVサンプル", 4 + 32 ) == 6; flag = 5; return flag; end
				end
			...
			when ap2
				...
				if Input.mouse_push?(M_LBUTTON) then
					...
					#「はい」を押すと終了
					if messagebox.Popup("稲佐の浜に行きますか？", 10, "DXRuby ADVサンプル", 4 + 32 ) == 6; flag = 4; return flag; end
				end
			...
			when ap3
				...
				if Input.mouse_push?(M_LBUTTON) then
					...
					#「はい」を押すと終了
					if messagebox.Popup("出雲大社に行きますか？", 10, "DXRuby ADVサンプル", 4 + 32 ) == 6; flag = 2; return flag; end
				end
			...
			when ap4
				...
				if Input.mouse_push?(M_LBUTTON) then
					...
					#「はい」を押すと終了
					if messagebox.Popup("旧大社駅に行きますか？", 10, "DXRuby ADVサンプル", 4 + 32 ) == 6; flag = 3; return flag; end
				end
			...
			when ap5
				...
				if Input.mouse_push?(M_LBUTTON) then
					...
					#「はい」を押すと終了
					if messagebox.Popup("須佐神社に行きますか？", 10, "DXRuby ADVサンプル", 4 + 32 ) == 6; flag = 7; return flag; end
				end
			...
			when ap6
				...
				if Input.mouse_push?(M_LBUTTON) then
					...
					#「はい」を押すと終了
					if messagebox.Popup("立久恵峡に行きますか？", 10, "DXRuby ADVサンプル", 4 + 32 ) == 6; flag = 6; return flag; end
				end
		end
